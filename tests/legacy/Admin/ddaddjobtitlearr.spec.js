...
const Jobtitles = ["QA I", "QA II", "QA III"]

for (let title of Jobtitles) {

  test(`Verify add jobtitle - ${title}`, async ({ page }) => {
    ...
    await page.locator("//div[@class='oxd-input-group oxd-input-field-bottom-space']//div//input[@class='oxd-input oxd-input--active']").fill(title)
