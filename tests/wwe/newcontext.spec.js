...
test.describe('Automation - Working With Elements', () => {
  ...
  test("browse context test", async ({browser}) => {
    ...
    await page1.getByPlaceholder('First Name').fill(`vittal`);
    await page1.getByPlaceholder('Last Name').fill(`xyz`);
    ...
    await page1.locator("//label[text()='Username']/../following-sibling::div/input").fill("vittalxyz")
    ...
    await page2.locator('input[name="username"]').fill("vittalxyz")
